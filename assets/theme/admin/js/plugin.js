      ...
      switch (t) {
        case "light-mode-switch":
          document.documentElement.removeAttribute("dir"),
            "/duan1_nhom1/assets/theme/admin/css/bootstrap.min.css" !=
            ...
            "/duan1_nhom1/assets/theme/admin/css/app.min.css" !=
              document.getElementById("app-style").getAttribute("href") &&
              document
                .getElementById("app-style")
                .setAttribute("href", "/duan1_nhom1/assets/theme/admin/css/app.min.css"),
